...
tox
```
- After tests if anything is missing in the tests - inspect coverage - go to htmlcov folder that should appear after tox finished running. Use index.html to navigate
